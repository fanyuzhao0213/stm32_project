...
{
	Soft_IIC_Start();
	Soft_IIC_Write_Byte(0x78);            //Slave address,SA0=0
	IIC_Delay(1);
	Soft_IIC_Write_Byte(0x00);			//write command
	IIC_Delay(1);
	Soft_IIC_Write_Byte(IIC_Command); 
	IIC_Delay(1);
	Soft_IIC_Stop();
}
/**********************************************
...
{
	 Soft_IIC_Start();
	 Soft_IIC_Write_Byte(0x78);			//D/C#=0; R/W#=0
	 IIC_Delay(1);	
	 Soft_IIC_Write_Byte(0x40);			//write data
	 IIC_Delay(1);	
	 Soft_IIC_Write_Byte(IIC_Data);
	 IIC_Delay(1);
	 Soft_IIC_Stop();
}
