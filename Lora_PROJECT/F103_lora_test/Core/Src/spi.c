...
{
	return HAL_SPI_Transmit(&hspi1, pBuffer, byteCount, MAX_TIMEOUT);
}
...
{
	return HAL_SPI_Receive(&hspi1, pBuffer, byteCount, MAX_TIMEOUT);
}
...
{
	return HAL_SPI_Transmit(&hspi2, pBuffer, byteCount, MAX_TIMEOUT);
}
...
{
	uint8_t	byteData=0;
	HAL_SPI_Receive(&hspi2, &byteData, 1, MAX_TIMEOUT);
	return  byteData;
}
...
{
	return HAL_SPI_Receive(&hspi2, pBuffer, byteCount, MAX_TIMEOUT);
}
