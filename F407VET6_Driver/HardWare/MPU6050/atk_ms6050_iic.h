...
/* 引脚定义 */
#define ATK_MS6050_IIC_SCL_GPIO_PORT            GPIOE
#define ATK_MS6050_IIC_SCL_GPIO_PIN             GPIO_PIN_11
#define ATK_MS6050_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)
#define ATK_MS6050_IIC_SDA_GPIO_PORT            GPIOE
#define ATK_MS6050_IIC_SDA_GPIO_PIN             GPIO_PIN_10
#define ATK_MS6050_IIC_SDA_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)
