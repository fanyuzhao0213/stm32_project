...
void USART1_IRQHandler(void)
{
  /* USER CODE BEGIN USART1_IRQn 0 */
    uint32_t isrflags = READ_REG(huart1.Instance->SR);  // ��ȡ״̬�Ĵ���
    uint32_t cr1its   = READ_REG(huart1.Instance->CR1); // ��ȡ���ƼĴ���

	/*USART_CR1_IDLEIE CR1�Ĵ����е�IDLE�ж�ʹ��λ���û�����Ƿ�������Ӧ�����жϡ�*/
    /* �ж��Ƿ������IDLE�ж� */
    if(((isrflags & USART_SR_IDLE) != RESET) && ((cr1its & USART_CR1_IDLEIE) != RESET))
    {
        __HAL_UART_CLEAR_IDLEFLAG(&huart1);  // ���IDLE��־λ
        HAL_UART_IDLECallback(&huart1);      // �����Զ���ص�����
    }
