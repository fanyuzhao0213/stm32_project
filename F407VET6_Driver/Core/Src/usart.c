...
uint16_t uart_rx_len = 0;    // ʵ�ʽ��յ������ݳ���
uint8_t uart_frame_flag = 0; // һ֡������ɱ�־
/* USER CODE END 0 */
...
void my_data_analysis(void)
{
	...
	if(uart_frame_flag)
	{
		...
		{
			rtt_printf("%02X ", uart_frame_buf[i]); // ��16���Ƹ�ʽ��ӡ
		}
		rtt_printf("\r\n");
