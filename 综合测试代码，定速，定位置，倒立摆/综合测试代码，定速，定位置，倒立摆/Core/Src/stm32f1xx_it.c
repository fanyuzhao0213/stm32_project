...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef* tim_baseHandle)
{
	...
	if(tim_baseHandle->Instance == htim1.Instance)
	{
		...
		if (currentSystemStage == nextSystemStage)
		{
			switch (currentSystemStage)
			{
				case SYSTEM_STAGE_SPEED_CONTROL: 
					motor_speed_control_Tick(); break;
				case SYSTEM_STAGE_LOCATION_CONTROL: 
					motor_location_control_Tick(); break;
				case SYSTEM_STAGE_DAOLIBAI_CONTROL: 
					systerm_daolibai_Tick(); break;
			}
		}
